...
namespace LiteTracker.UI
{
    ...
    public sealed partial class DispatchNotesPage : LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var dispatchNoteSummaries = new DispatchNoteSummaries();
            var dispatchLineSummaries = new DispatchLineSummaries();
            var service = new TrackingServices();
            var task = service.GetDispatchNotes(dispatchNoteSummaries.AllSummaries, dispatchLineSummaries.AllSummaries);     
            

            DefaultViewModel["Summaries"] = dispatchNoteSummaries.AllSummaries;            
